...
export const HeroModule = () => {
  return (
    <div className="h-lvh w-auto backgroundImage flex justify-center ">
      <div className="w-80 h-2/3 md:w-1/2  mt-20 md:mt-32 bg-black bg-opacity-90 flex flex-col items-center  space-y-12">
        <Image
        ...
        />
        <div>
          <h2 className="text-white w-64 text-2xl text-center -my-8 md:-my-12 md:w-3/4 mx-auto">
